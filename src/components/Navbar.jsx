...
const Navbar = () => {
    return (
        <nav className="bg-[#0F1015]/70 text-gray-300 px-0 flex justify-between items-center flex-col fixed top-0 left-0 w-full z-50 shadow-lg">
            <div className="flex items-center justify-between h-12 w-full px-10 py-2">
                <div className="flex items-center space-x-4">
                    <img className="h-7 pr-8" src="/FlameLogo.svg" alt="" />
            ...
            <div className="h-20 w-full bg-[#16171B] px-10 py-2 flex justify-center align-center items-center gap-5">
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 1024 1024">
                    <path fill="#ddd" d="M160 448a32 32 0 0 1-32-32V160.064a32 32 0 0 1 32-32h256a32 32 0 0 1 32 32V416a32 32 0 0 1-32 32zm448 0a32 32 0 0 1-32-32V160.064a32 32 0 0 1 32-32h255.936a32 32 0 0 1 32 32V416a32 32 0 0 1-32 32zM160 896a32 32 0 0 1-32-32V608a32 32 0 0 1 32-32h256a32 32 0 0 1 32 32v256a32 32 0 0 1-32 32zm448 0a32 32 0 0 1-32-32V608a32 32 0 0 1 32-32h255.936a32 32 0 0 1 32 32v256a32 32 0 0 1-32 32z" />
                </svg>
