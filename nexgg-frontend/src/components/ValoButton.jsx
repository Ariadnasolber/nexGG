...
const ValoButton = () => {
    return (
        <button className="m-0 text-white text-sm font-thin focus:outline-none hover:bg-zinc-950 h-15 w-fit cursor-pointer ring-1 ring-zinc-800 flex items-center justify-center gap-3 px-10">
