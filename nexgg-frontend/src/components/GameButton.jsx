...
const GameButton = () => {
    return (
        <button className="m-0 rounded-full bg-[#0F0F12] text-white text-sm font-thin focus:outline-none hover:bg-zinc-950 h-7 w-fit cursor-pointer ring-1 ring-zinc-800 flex items-center justify-start gap-1 px-3">
